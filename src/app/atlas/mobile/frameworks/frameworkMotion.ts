...
export const FRAMEWORK_READING_HANDOFF_DURATION = 520;
export const FRAMEWORK_READING_REDUCED_HANDOFF_DURATION = 160;
export const FRAMEWORK_RETURN_DURATION = 480;
export const FRAMEWORK_RETURN_REDUCED_DURATION = 160;
